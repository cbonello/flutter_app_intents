...
const config: Config = {
  ...
  tagline: 'A Flutter plugin for integrating Apple App Intents with your iOS applications.',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Christophe Bonello. Built with Docusaurus.`,
    },
    prism: {
