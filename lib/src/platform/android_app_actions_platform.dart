...
class AndroidAppActionsPlatform extends AppIntentsPlatform {
  ...
  bool get isSupported {
    // Return cached value if available, otherwise assume Android is supported
    // (actual API level check happens asynchronously on first method call)
    return _isSupportedCache ?? Platform.isAndroid;
  }
  ...
  Future<bool> donateIntent(
    ...
    return _invokePlatformMethod<bool>(
      ...
      errorMessage: 'Failed to donate intent',
      defaultValue: false,
    );
  }
  ...
  Future<bool> donateIntentBatch(
    ...
    return _invokePlatformMethod<bool>(
      ...
      errorMessage: 'Failed to donate intent batch',
      defaultValue: false,
    );
  }
  ...
  /// Initializes the method call handler if not already initialized.
  /// This sets up the channel to receive intent invocations from Android.
  ...
  /// Invokes a platform method with standardized error handling.
  ///
  /// Wraps platform exceptions in [FlutterAppIntentsException] with
  /// a consistent error message format.
  Future<T> _invokePlatformMethod<T>(
    String method,
    dynamic arguments, {
